# Girilen kullanıcı adının takipçi sayısı, takip edilen sayısı, gönderi sayısı ve en son gönderinin ne zaman gönderildiğine dait bilgileri kullanıcıya döndüren uygulama örneğidir.
